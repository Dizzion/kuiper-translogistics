...
export const TNGetAll = async (): Promise<RecordModel> => {
  const res = await fetch(
    `${process.env.APP_SERVER}/api/collections/TrackingNumbers/records?perPage=500`,
    { cache: "no-store" }
  );
...
export const TNGetByTN = async (
  ...
  const res = await fetch(
    `${process.env.APP_SERVER}/api/collections/TrackingNumbers/records?filter=(TrackingNumber~'${trackingNumber}')&expand=HU`,
    { cache: "no-store" }
  );
...
export const TNGetOne = async (id: string): Promise<RecordModel> => {
  const res = await fetch(
    `${process.env.APP_SERVER}/api/collections/TrackingNumbers/records/${id}`,
    { cache: "no-store" }
  );
  const tn = await res.json();
  return tn;
...
export const TNCreate = async (
  ...
  const res = await fetch(
    `${process.env.APP_SERVER}/api/collections/TrackingNumbers/records`,
    {
      method: "POST",
      headers: {
...
export const ContGetAll = async (): Promise<Object> => {
  const res = await fetch(
    `${process.env.APP_SERVER}/api/collections/Containers/records/`,
    { cache: "no-store" }
  );
...
export const ContGetByContId = async (contId: string): Promise<RecordModel> => {
  const res = await fetch(
    `${process.env.APP_SERVER}/api/collections/Containers/records?filter=(ContainerID='${contId}')&expand=TrackingNumbers,SapTotes`,
    { cache: "no-store" }
  );
...
export const ContGetOne = async (id: string): Promise<RecordModel> => {
  const res = await fetch(
    `${process.env.APP_SERVER}/api/collections/Containers/records/${id}?expand=TrackingNumbers,SapTotes`,
    { cache: "no-store" }
  );
...
export const STGetAll = async (): Promise<Object> => {
  const res = await fetch(
    `${process.env.APP_SERVER}/api/collections/SapTotes/records`,
    { cache: "no-store" }
  );
...
export const STGetBySTID = async (stId: string): Promise<RecordModel> => {
  const res = await fetch(
    `${process.env.APP_SERVER}/api/collections/SapTotes/records?filter=(ToteID='${stId}')`,
    { cache: "no-store"}
  );
...
export const STGetOne = async (id: string): Promise<RecordModel> => {
  const res = await fetch(
    `${process.env.APP_SERVER}/api/collections/SapTotes/records/${id}?expand=HU`,
    { cache: "no-store" }
  );
  const ST = await res.json();
  return ST;
...
export const STUpdate = async (
  ...
  const res = await fetch(
    `${process.env.APP_SERVER}/api/collections/SapTotes/records/${id}`,
    {
      method: "PATCH",
      headers: {
        "Content-Type": "application/json",
...
export const TruckGetAll = async (): Promise<Object> => {
  const res = await fetch(
    `${process.env.APP_SERVER}/api/collections/Trucks/records`,
    { cache: "no-store" }
  );
...
export const TruckGetByContArr = async (
  ...
  const res = await fetch(
    `${process.env.APP_SERVER}/api/collections/Trucks/records?filter=(Containers~'${conts}')`,
    { cache: "no-store" }
  );
...
export const TruckGetOne = async (id: string): Promise<RecordModel> => {
  const res = await fetch(
    `${process.env.APP_SERVER}/api/collections/Trucks/records/${id}`,
    { cache: "no-store" }
  );
...
export const getEmployeeByFullName = async (
  ...
  const res = await fetch(
    `${process.env.APP_SERVER}/api/collections/Employees/records?filter=(Full_Name="${fullName}")`,
    { cache: "no-store" }
  );
...
export const addEmployees = async (
  ...
  const res = await fetch(
    `${process.env.APP_SERVER}/api/collections/Employees/records`,
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
...
export const updateEmployees = async (
  ...
  const res = await fetch(
    `${process.env.APP_SERVER}/api/collections/Employees/records/${id}`,
    {
      method: "PATCH",
      headers: {
        "Content-Type": "application/json",
...
export const getAssociates = async (): Promise<RecordModel[]> => {
  const res = await fetch(
    `${process.env.APP_SERVER}/api/collections/WarehouseAssociates/records?perPage=500`,
    { cache: "no-store" }
  );
...
export const HUGetAll = async (): Promise<Object> => {
  const res = await fetch(
    `${process.env.APP_SERVER}/api/collections/HandlingUnits/records`,
    { cache: "no-store" }
  );
  const HUs = res.json();
  return HUs;
...
export const HUGetByHU = async (hu: number): Promise<RecordModel> => {
  const res = await fetch(
    `${process.env.APP_SERVER}/api/collections/HandlingUnits/records?filter=(HU='${hu}')`,
    { cache: "no-store" }
  );
  const HU = res.json();
  return HU;
...
export const HUGetOne = async (id: string): Promise<RecordModel> => {
  const res = await fetch(
    `${process.env.APP_SERVER}/api/collections/HandlingUnits/records/${id}`,
    { cache: "no-store" }
  );
  const HU = res.json();
  return HU;
